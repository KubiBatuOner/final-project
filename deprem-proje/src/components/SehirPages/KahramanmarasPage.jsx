import { ReactComponent as Map } from "../../images/svgKahramanmaras.svg";
import Kahramanmaras from "../Sehirler/Kahramanmaras";
import NewHeader from "../newHeader";
import { useEffect } from "react";

export default function KahramanmarasPage() {
  useEffect(() => {
  ...
  return (
    <div className="flex justify-center items-center h-auto rounded-[40px] bg-[#D9E8E7]">
      <div className="flex bg-white w-full rounded-[40px] my-5 mx-5 ">
        ...
        <div className="flex-2 flex flex-col mt-10 mr-10 pt-5 px-5 mb-3 rounded-lg bg-[url('mapZone.png')] bg-intro">
