...
export default function HomePage() {
  return (
    <>
      <div className="flex justify-center items-center h-auto rounded-[40px] bg-[#D9E8E7] max-[415px]:hidden">
      ...
      <div className="flex flex-col justify-center items-center min-[415px]:hidden">
        <NewHeader />
      </div>
    </>
  );
